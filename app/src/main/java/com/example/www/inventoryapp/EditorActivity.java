...
import static com.example.www.inventoryapp.data.InventoryProvider.LOG_TAG;
...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) findViewById(R.id.image_textview);
        imageTextView = (TextView) findViewById(R.id.NoIv);
    ...
    private void saveProduct() {
        ...
        if (TextUtils.isEmpty(nameString)) {
            mNameEditText.setError("What is the name of the product?");
            return;
        }

        String quantityString = mQuantityEditText.getText().toString().trim();
        if (TextUtils.isEmpty(quantityString)) {
           mQuantityEditText.setError("How much of the product is in stock?");
            return;
        }
        ...
        if(TextUtils.isEmpty((phoneNumberString))){
            mPhoneNumberEditText.setError("What is the phone number?");
            return;
        }
      ...
      QuantityNumber = Integer.parseInt(quantityString);
        ...
        if(imageString == null){
            Toast.makeText(this, "Please show a product photo", Toast.LENGTH_SHORT).show();
            return;
        }
